...
import org.jetbrains.bsp.bazel.projectview.parser.sections.ProjectViewManualTargetsSectionParser
...
open class ProjectViewParserImpl : ProjectViewParser {
    ...
    private fun parseWithDefault(projectViewFileContent: String, defaultProjectView: ProjectView): Try<ProjectView> {
        ...
        return ProjectView.Builder(
                ...
                buildManualTargets = buildManualTargetsParser.parseOrDefault(rawSections, Option.of(defaultProjectView.buildManualTargets)).orNull,
        ).build()
    }
    ...
    override fun parse(projectViewFileContent: String): Try<ProjectView> {
        ...
        return ProjectView.Builder(
                ...
                buildManualTargets = buildManualTargetsParser.parse(rawSections).orNull,
        ).build()
    }
    ...
    private companion object {
        ...
        private val buildManualTargetsParser = ProjectViewManualTargetsSectionParser()
    }
}
