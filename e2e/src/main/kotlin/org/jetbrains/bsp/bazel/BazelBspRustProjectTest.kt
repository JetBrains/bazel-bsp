...
object BazelBspRustProjectTest : BazelBspTestBaseScenario() {
    ...
    private fun makeBuildTarget(
        ...
        val buildtarget = BuildTarget(
            ...
            listOf("rust"),
            dependencies,
            BuildTargetCapabilities().also { it.canCompile = true; it.canTest = false; it.canRun = canRun; it.canDebug = false }
        )
    ...
    private fun expectedPackageFromDependency(name: String, version: String, features: Set<String> = setOf()): RustPackage {
    ...
    private fun expectedTargetFromDependency(name: String, packageRootUrl: String, features: Set<String> = setOf()): List<RustTarget> =
        listOf(
            RustTarget(
                name.replace("-", "_"),
    ...
    private fun expectedDependencies(): Map<String, List<RustDependency>> {
        val exampleDependencies = createDependency(listOf(
    ...
    private fun expectedRawDependencies(): Map<String, List<RustRawDependency>> {
        val exampleDependencies = createRawDependency(listOf("@//example-lib:example_lib", "@crate_index__itertools-0.10.5//:itertools"))
