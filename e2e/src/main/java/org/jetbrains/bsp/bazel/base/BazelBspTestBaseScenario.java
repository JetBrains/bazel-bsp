...
public abstract class BazelBspTestBaseScenario {
  ...
  protected final BazelTestClient testClient;
  ...
  private BazelTestClient createClient(Path workspacePath) {
    ...
    var client = new BazelTestClient(workspacePath, initializeBuildParams);
