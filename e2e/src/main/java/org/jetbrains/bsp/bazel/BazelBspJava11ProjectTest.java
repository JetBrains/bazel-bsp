...
public class BazelBspJava11ProjectTest extends BazelBspTestBaseScenario {
  ...
  protected List<BazelBspTestScenarioStep> getScenarioSteps() {
    return ImmutableList.of(java11ProjectWorkspaceBuildTargets());
  }

  private BazelBspTestScenarioStep java11ProjectWorkspaceBuildTargets() {
    JvmBuildTarget exampleExampleJvmBuildTarget =
        new JvmBuildTarget("external/local_jdk/", "11");
