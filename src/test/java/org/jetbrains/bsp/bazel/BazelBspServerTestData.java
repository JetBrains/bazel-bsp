      ...
      new SourcesResult(
          ImmutableList.of(
              new SourcesItem(
                  ID_1,
                  ImmutableList.of(
                      new SourceItem(SAMPLE_REPO_EXAMPLE_PATH + "/Example.scala", SourceItemKind.FILE, false))),
              new SourcesItem(
                  ID_2,
                  ImmutableList.of(
                      new SourceItem(SAMPLE_REPO_DEP_PATH + "/Test.scala", SourceItemKind.FILE, false),
                      new SourceItem(SAMPLE_REPO_DEP_PATH + "/JavaTest.java", SourceItemKind.FILE, false),
                      new SourceItem(SAMPLE_REPO_DEP_PATH + "/Dep.scala", SourceItemKind.FILE, false)))));
