...
RULES_BAZEL_INTEGRATION_TEST_TAG = "0.16.0"

RULES_BAZEL_INTEGRATION_TEST_SHA = "cae27bc907fa036e40e57c952867a2ea8ea0ef7e10ecd599ce09887bf60fb1af"
...
maven_install(
    artifacts = [
        ...
        "io.kotest:kotest-assertions-api-jvm:5.7.1",
        "io.kotest:kotest-assertions-core-jvm:5.7.1",
        "io.kotest:kotest-assertions-shared-jvm:5.7.1",
        "io.kotest:kotest-common-jvm:5.7.1",
    ],
    fetch_sources = True,
    repositories = [
