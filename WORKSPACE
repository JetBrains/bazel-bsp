...
maven_install(
    artifacts = [
        ...
        "io.kotest:kotest-assertions-api-jvm:5.7.0",
        "io.kotest:kotest-assertions-core-jvm:5.7.0",
        "io.kotest:kotest-assertions-shared-jvm:5.7.0",
        "io.kotest:kotest-common-jvm:5.7.0",
    ],
    fetch_sources = True,
    repositories = [
