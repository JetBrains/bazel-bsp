...
object BazelBspGitHub : Project({
    ...
    val allSteps = sequential {
        ...
        parallel(options = {
            ...
            buildType(BazelE2eTests.LocalJdkTestGitHub)
            buildType(BazelE2eTests.RemoteJdkTestGitHub)
...
object BazelBspSpace : Project({
    ...
    val allSteps = sequential {
        ...
        parallel(options = {
            ...
            buildType(BazelE2eTests.LocalJdkTestSpace)
            buildType(BazelE2eTests.RemoteJdkTestSpace)
