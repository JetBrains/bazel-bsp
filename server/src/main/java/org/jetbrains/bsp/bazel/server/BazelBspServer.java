...
public class BazelBspServer {
  ...
  public BazelBspServer(
    ...
    var bspProjectMapper = new BspProjectMapper(serverContainer.languagePluginsService, workspaceContextProvider);
    var projectSyncService =
        new ProjectSyncService(bspProjectMapper, serverContainer.projectProvider);
    var executeService =
        new ExecuteService(compilationManager, serverContainer.projectProvider, bazelRunner, workspaceContextProvider);
