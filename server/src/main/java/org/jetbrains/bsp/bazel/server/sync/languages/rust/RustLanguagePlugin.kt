            ...
            listOf<RustPackage>(
                RustPackage(
                    ...
                    listOf<RustTarget>(
                        RustTarget(
                            "hello_world",
                            "file:///home/mikolaj/Desktop/zpp/rust-bazel-bsp-sample/hello_world/src/main.rs",
                            "application",
                            "2018",
                            false,
                            listOf<String>()
                    ...
                    null,
                    listOf<RustEnvData>(
                        RustEnvData("CARGO_MANIFEST_DIF", "/home/mikolaj/Desktop/zpp/rust-bazel-bsp-sample/hello-world"),
                ...
                RustPackage(
                    ...
                    listOf<RustTarget>(
                        RustTarget(
                            "hello_lib",
                            "file:///home/mikolaj/Desktop/zpp/rust-bazel-bsp-sample/hello_lib/src/lib.rs",
                            "library",
                            "2018",
                            false,
                            listOf<String>()
                    ...
                    null,
                    listOf<RustEnvData>(
                        RustEnvData("CARGO_MANIFEST_DIF", "/home/mikolaj/Desktop/zpp/rust-bazel-bsp-sample/hello_lib"),
                        RustEnvData("CARGO", "cargo"),
                        RustEnvData("CARGO_PKG_VERSION", "0.1.0"),
                        RustEnvData("CARGO_PKG_VERSION_MAJOR", "0"),
                        RustEnvData("CARGO_PKG_VERSION_MINOR", "1"),
